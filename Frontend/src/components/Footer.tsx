    ...
    <footer className="border-t bg-background/80 backdrop-blur-sm text-sm text-muted-foreground mt-auto">
      <div className="max-w-7xl mx-auto px-6 py-12 grid gap-10 md:grid-cols-4 lg:grid-cols-5">
        ...
        <div className="flex flex-col gap-3">
          ...
          <Link to="/add-address" className="hover:text-primary transition-colors">Address</Link>
      ...
      <div className="border-t border-border/50 px-6 py-6 text-center flex flex-col md:flex-row items-center justify-center max-w-7xl mx-auto">
