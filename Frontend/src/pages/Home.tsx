    ...
    <div className="min-h-screen bg-background flex flex-col overflow-hidden">
      ...
      <section className="relative px-6 py-32 md:py-48 flex flex-col items-center justify-center text-center overflow-hidden">
        ...
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full h-full max-w-7xl">
          <div className="absolute top-[20%] left-[20%] w-[40rem] h-[40rem] bg-orange-500/10 rounded-full blur-3xl" />
          <div className="absolute bottom-[10%] right-[20%] w-[35rem] h-[35rem] bg-rose-500/10 rounded-full blur-3xl" />
        </div>
