...
export const OrderSuccess = () => {
  ...
  return (
    <div className="min-h-[80vh] flex items-center justify-center bg-linear-to-br from-background via-muted/50 to-background px-4 py-16">
      <Card className="w-full max-w-md overflow-hidden rounded-2xl border bg-background/60 backdrop-blur-xl shadow-xl transition-all duration-300 hover:shadow-2xl">
        <CardContent className="p-8 text-center flex flex-col items-center">
          {loading ? (
            <div className="space-y-6 py-8">
              <div className="relative flex items-center justify-center">
                <div className="absolute h-16 w-16 animate-ping rounded-full bg-orange-100 dark:bg-orange-950/50 opacity-75"></div>
                <div className="relative rounded-full bg-orange-50 dark:bg-orange-950 p-4 text-orange-600">
            ...
            <div className="space-y-6 py-6">
              <div className="relative flex items-center justify-center">
                <div className="absolute h-20 w-20 animate-pulse rounded-full bg-green-100 dark:bg-green-950/30 opacity-75"></div>
              ...
              <div className="rounded-lg bg-muted/50 p-4 border text-left w-full space-y-1.5 text-xs text-muted-foreground">
              ...
              <div className="pt-4 flex flex-col sm:flex-row gap-3 w-full">
                ...
                <Button
                  ...
                  className="w-full sm:flex-1 bg-orange-600 hover:bg-orange-700 text-white gap-2"
                >
                  Shop More
                  <ArrowRight size={16} />
                </Button>
