...
const AdminPendingList = () => {
    ...
    return (
        <div className="p-8 space-y-8">
            <div>
                <h1 className="text-3xl font-bold tracking-tight text-primary">Pending Seller Approvals</h1>
                <p className="text-muted-foreground mt-1">Review and approve new seller registration requests.</p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {sellers.length > 0 ? (
                    ...
                    <div className="col-span-full py-12 text-center bg-muted/30 rounded-lg border border-dashed">
                        <p className="text-muted-foreground text-lg">No pending seller approvals.</p>
                    </div>
                )}
            </div>
        </div>
