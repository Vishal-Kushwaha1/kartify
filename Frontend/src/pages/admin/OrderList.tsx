...
const OrderList = () => {
    ...
    return (
        <div className="p-8 space-y-8">
            <div>
                <h1 className="text-3xl font-bold tracking-tight text-primary">All Orders</h1>
                <p className="text-muted-foreground mt-1">Manage and track all customer orders across the platform.</p>
            </div>
